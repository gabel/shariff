...
"use strict";module.exports=function(e){var r=encodeURIComponent(e.getURL()),o="https://www.facebook.com/sharer/sharer.php?u=";return{popup:!0,shareText:{de:"teilen",en:"share",es:"compartir"},name:"facebook",faName:"fa-facebook",title:{de:"Bei Facebook teilen",en:"Share on Facebook",es:"Compartir en Facebook"},shareUrl:o+r+e.getReferrerTrack(),setShareUrl:function(r){r&&(this.shareUrl=o+r+e.getReferrerTrack())}}};
},{}],7:[function(require,module,exports){
"use strict";module.exports=function(e){var r=encodeURIComponent(e.getURL()),o="https://plus.google.com/share?url=";return{popup:!0,shareText:"+1",name:"googleplus",faName:"fa-google-plus",title:{de:"Bei Google+ teilen",en:"Share on Google+",es:"Compartir en Google+"},shareUrl:o+r+e.getReferrerTrack(),setShareUrl:function(r){r&&(this.shareUrl=o+r+e.getReferrerTrack())}}};
...
"use strict";var url=require("url");module.exports=function(e){var t=function(t){var r=url.parse("https://twitter.com/intent/tweet",!0);return r.query.text=decodeURIComponent(e.getShareText()),r.query.url=t?t:e.getURL(),null!==e.options.twitterVia&&(r.query.via=e.options.twitterVia),delete r.search,r},r={popup:!0,shareText:"tweet",name:"twitter",faName:"fa-twitter",title:{de:"Bei Twitter teilen",en:"Share on Twitter",es:"Compartir en Twitter"},shareUrl:url.format(t(null))+e.getReferrerTrack(),setShareUrl:function(r){r&&(this.shareUrl=url.format(t(r))+e.getReferrerTrack())}};return r};
},{"url":5}],11:[function(require,module,exports){
"use strict";module.exports=function(e){var t=encodeURIComponent(e.getURL()),r=function(){return"whatsapp://send?text="+e.getShareText()+"%20"};return{popup:!1,shareText:{de:"teilen",en:"share",es:"compartir"},name:"whatsapp",faName:"fa-whatsapp",title:{de:"Bei Whatsapp teilen",en:"Share on Whatsapp",es:"Compartir en Whatsapp"},shareUrl:r()+t+e.getReferrerTrack(),setShareUrl:function(t){t&&(this.shareUrl=r()+t+e.getReferrerTrack())}}};
},{}],12:[function(require,module,exports){
(function (global){
"use strict";var $=(typeof window !== "undefined" ? window.jQuery : typeof global !== "undefined" ? global.jQuery : null),_Shariff=function(t,e){var r=this;this.element=t,this.options=$.extend({},this.defaults,e,$(t).data());var n=[require("./services/facebook"),require("./services/googleplus"),require("./services/twitter"),require("./services/whatsapp"),require("./services/mail"),require("./services/info")];"custom"===this.options.theme&&(this.options.services=$.map($(".deputy-shariff [data-share-service]"),function(t){var e=$(t).attr("data-share-service");return e?e:null})),this.services=$.map(this.options.services,function(t){var e;return n.forEach(function(n){return n=n(r),n.name===t?(e=n,null):void 0}),e}),"custom"!==this.options.theme?this._addButtonList():this._initCustomButtons(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};_Shariff.prototype={defaults:{theme:"color",backendUrl:null,infoUrl:"http://ct.de/-2467514",lang:"de",orientation:"horizontal",referrerTrack:null,services:["facebook","twitter","googleplus","info"],shareText:"",twitterVia:null,url:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getLocalized:function(t,e){return"object"==typeof t[e]?t[e][this.options.lang]:"string"==typeof t[e]?t[e]:void 0},getMeta:function(t){var e=$('meta[name="'+t+'"],[property="'+t+'"]').attr("content");return e||""},getInfoUrl:function(){return this.options.infoUrl},getURL:function(){var t=this.options.url;return"function"==typeof t?$.proxy(t,this)():t},setURL:function(t){var e=this;return e.options.url=t?t:e.options.url,$.map(e.services,function(r){"function"==typeof r.setShareUrl&&(r.setShareUrl(t),e.$socialshareElement().find("[data-share-service="+r.name+"]").attr("href",r.shareUrl))}),e},getReferrerTrack:function(){return this.options.referrerTrack||""},getShares:function(){return $.getJSON(this.options.backendUrl+"?url="+encodeURIComponent(this.getURL()))},_updateCounts:function(t){var e=this;$.each(t,function(t,r){r>=1e3&&(r=Math.round(r/1e3)+"k"),$(e.element).find("."+t+" a").append('<span class="share_count">'+r)})},_addButtonList:function(){var t=this,e=this.$socialshareElement(),r="theme-"+this.options.theme,n="orientation-"+this.options.orientation,i=$("<ul>").addClass(r).addClass(n);this.services.forEach(function(e){var r=$('<li class="shariff-button">').addClass(e.name),n='<span class="share_text">'+t.getLocalized(e,"shareText"),a=$("<a>").attr("href",e.shareUrl).attr("data-share-service",e.name).append(n);"undefined"!=typeof e.faName&&a.prepend('<span class="fa '+e.faName+'">'),e.popup?a.attr("rel","popup"):a.attr("target","_blank"),a.attr("title",t.getLocalized(e,"title")),r.append(a),i.append(r)}),i.on("click",'[rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href"),r=$(this).attr("title"),n="600",i="460",a="width="+n+",height="+i;global.window.open(e,r,a)}),e.append(i)},_initCustomButtons:function(){var t=this,e=t.$socialshareElement(),r=e.find("a[data-share-service]");return t.services.forEach(function(e){var n=r.filter("[data-share-service="+e.name+"]");n.length&&(n.attr("href",e.shareUrl).attr("data-share-service",e.name),e.popup?n.attr("rel","popup"):n.attr("target","_blank"),n.attr("title",t.getLocalized(e,"title")))}),r.on("click",function(t){t.preventDefault();var e=$(this).attr("href"),r=$(this).attr("title"),n="600",i="460",a="width="+n+",height="+i;global.window.open(e,r,a)}),t},abbreviateText:function(t,e){var r=$("<div/>").html(t).text();if(r.length<=e)return t;var n=r.substring(0,e-1).lastIndexOf(" ");return r=encodeURIComponent(r.substring(0,n))+"…"},getShareText:function(){if(""!==this.options.shareText)return encodeURIComponent(this.abbreviateText(this.options.shareText,120));var t=this.getMeta("DC.title"),e=this.getMeta("DC.creator");return t.length>0&&e.length>0?t+=" - "+e:t=$("title").text(),encodeURIComponent(this.abbreviateText(t,120))},setShareText:function(t){var e=this;return e.options.shareText=t,e.setURL(e.getURL()),e}},module.exports=_Shariff,$(".shariff").each(function(){this.hasOwnProperty("shariff")||(this.shariff=new _Shariff(this))}),global.window.Shariff=_Shariff;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
